...
description: "Internal preference-evidence capture rules loaded by design-system."
---
...
1. Resolve registry, binding, profile, and context through [resolver.md](resolver.md).
2. Identify accepted choice, rejected choice, observable signals, stated reason, confidence, and narrowest valid scope.
3. Append one JSON object per line using [evidence.schema.json](evidence.schema.json).
