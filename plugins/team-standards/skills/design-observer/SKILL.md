...
description: "Capture explicit user reactions to a UI or design choice as scoped Preference Evidence in the evidence-driven design registry. Use when users say a UI feels too AI-generated, comfortable, fragmented, overly rounded, prefer one option, reject a reference, or otherwise express a concrete visual preference."
---
...
Do not infer preference from silence, code frequency, or an unreviewed screenshot. Preserve contradictions. Do not invoke `design-pattern-miner` for one observation unless repeated evidence already exists.
