...
description: "Internal implementation-orientation rules loaded by change-readiness; not a standalone Skill."
---
...
```
bug-doc-required / change-readiness
        ↓ 文档写完，坐标已固化
change-readiness 代码定位模式       ← 本参考
        ↓ 代码已定位，上下文已加载
