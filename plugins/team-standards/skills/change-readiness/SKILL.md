...
10. 将 [文档同步](../markdown-writing-standards/SKILL.md#作业交付时同步文档) 纳入当前变更范围；本次任务完成后按 [提交规范](../git-commit-standards/SKILL.md) 自动提交已验证的实现和受影响文档。完成当前切片即可提交，不为等待整个 change 归档而积压已完成作业。
